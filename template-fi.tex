...
\newline
Pariohjelmoinnilla on todettu olevan ohjelmakoodin laatuun ja parien ongelmanratkaisukykyyn positiivisia vaikutteita \cite{pairprogramming}. Ongelmat ratkeavat jopa 60\% siitä ajasta mitä yksin ohjelmoivat henkilöt käyttävät saman ongelman ratkaisuun \cite{meta}. Virheiden määrä ohjelmissa myös pienenee jopa 25\% \cite{williams00str}.
\newline
