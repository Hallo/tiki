...
\abstract{Pariohjelmoinnilla tiedetään olevan positiivinen vaikutus ohjelmakoodin laatun, mutta vie keskimääräisesti enemmän henkilötyötunteja, kuin yksin ohjelmoidessa. Onko pariohjelmointi taloudellisesti varteenotettava ohjelmistokehitysmuoto? Selvitämme paraneeko ohjelmakoodin laatu niin paljon että ohjelman ylläpitovaiheessa saadaan korvattua ylimenneet henkilötyötunnit toteutusvaiheesta.}
